...
const FooterSection = () => {
  return (
    <section className="w-full border-t max-w-screen-2xl px-[1rem] md:px-14 mx-auto flex flex-col md:flex-row items-start gap-10 mt-10 md:mt-20">
      <div className="md:w-[60%] w-full mt-5 flex gap-6 lg:justify-between">
      ...
      <div className="md:w-[40%] w-full flex items-center justify-center mt-5">
